...
# The order of the "gameVersions" below is: Era/SoD, TBC, WotLK (3.80.0), MoP
CF_METADATA=$(cat <<-EOF
{
    ...
    "gameVersions": [14029, 14300, 14282, 14102]
}
EOF
)
...
response=$(curl -sS \
    ...
    "https://wow.curseforge.com/api/projects/1149594/upload-file")
