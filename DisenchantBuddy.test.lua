...
describe("DisenchantBuddy", function()
    ...
    describe("OnTooltipSetItem", function()
        ...
        it("should show tooltip for uncommon level 5 items", function()
            ...
            assert.spy(gameTooltipMock.AddLine).was.called_with(gameTooltipMock, "|T132858:0|t" .. " |c" .. Colors.STANDARD .. "Strange Dust" .. "|r")
            assert.spy(gameTooltipMock.AddLine).was.called_with(gameTooltipMock, "|T132867:0|t" .. " |c" .. Colors.GOOD .. "Lesser Magic Essence" .. "|r")
        end)
