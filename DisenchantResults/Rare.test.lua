describe("GetMaterialsForRareItem", function()
    ...
    it("should return correct results for level 26 items", function()
        ...
        assert.are_same({{itemId = Materials.LARGE_GLIMMERING_SHARD, probability = 100}}, results)
    end)
    ...
    it("should return correct results for level 31 items", function()
        ...
        assert.are_same({{itemId = Materials.SMALL_GLOWING_SHARD, probability = 100}}, results)
    end)
    ...
    it("should return correct results for level 36 items", function()
        ...
        assert.are_same({{itemId = Materials.LARGE_GLOWING_SHARD, probability = 100}}, results)
    end)
